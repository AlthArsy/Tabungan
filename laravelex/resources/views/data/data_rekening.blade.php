...
<body>
    <h2 align="center">Data Rekening Siswa</h2>
 @if(session('success'))
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <a href="{{ route('input.input_rekening') }}">Tambah Rekening</a>
                        <br>
                        @if(session('success'))
                            <p style="color: green">{{ session('success') }}</p>
                        @endif
                                    ...
                                    <tbody>
                                        @forelse($rekening as $r)
                                            <tr>
                                                ...
                                                <td>{{ $r->tahun_daftar }}</td>
                                                <td>{{ $r->created_at}}</td>
                                            </tr>
                                        @empty
                                            <tr><td colspan="4">Belum ada data rekening</td></tr>
                                        @endforelse
                                    </tbody>
                                </table>
                            </div>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Tabungan Mudikal 2026</div>
                            <div>
